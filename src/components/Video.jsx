      ...
      <VStack w={'full'}>
        ...
        <VStack alignItems={'flex-start'} p={8} w={'full'} overflowY={'auto'}>
          ...
          <Text>
            ...
            recusandae fugiat, atque consequatur quae necessitatibus quo nostrum
            facere odio libero et corporis aspernatur a molestias voluptate.
            Facere praesentium corporis alias. Temporibus dolores ducimus omnis,
            praesentium similique iusto, quis cupiditate pariatur sunt sequi
            aliquid voluptatem velit repellat illo in cumque libero ex? Sint
            magni lendus amet quo enim ducimus error quas.
          </Text>
        </VStack>
      </VStack>
